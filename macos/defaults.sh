...
sudo scutil --set ComputerName "Waking's 💻"
sudo scutil --set HostName "Waking's 💻"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "Waking's 💻"
...
# Sleep the display after 180 minutes
...
# Save screenshots to the ${HOME}/Documents/Screenshots
...
# Hidden the ~/Desktop floder
sudo chflags hidden ~/Desktop/*
...
defaults write com.google.Chrome.dev AppleEnableMouseSwipeNavigateWithScrolls -bool false
